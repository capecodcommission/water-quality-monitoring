    ...
    esriLoader.loadModules(
      [
        ...
        var embayments = new FeatureLayer({
          url: "https://gis-services.capecodcommission.org/arcgis/rest/services/wMVP/WaterQualityMonitoringStations/MapServer/1",
          outFields: ['*']
        });
        ...
        var stations = new FeatureLayer({
          url: "https://gis-services.capecodcommission.org/arcgis/rest/services/wMVP/WaterQualityMonitoringStations/MapServer/0",
